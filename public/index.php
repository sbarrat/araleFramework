 ...
 */
session_start();
require_once __DIR__.'/application/_inc/config.inc.php';
?>
<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="utf-8">
<title>Informaciones Enseñalia - <?php echo date('Y'); ?></title>
...
<body>
	...
	tabindex="10" placeholder="Nombre de usuario"/>
	<br/> 
	<label for="password">Contraseña:</label> 
	<input type="password" id="password" name="password" 
	tabindex="20" placeholder="Contraseña"/>
	<br/> 
	...
	<footer id="footer">
	Devel by &copy;sbarrat::<?php echo date("Y"); ?> - Powered by Arale Framework 0.1&nbsp;&nbsp;
	</footer>
</body>
</html>